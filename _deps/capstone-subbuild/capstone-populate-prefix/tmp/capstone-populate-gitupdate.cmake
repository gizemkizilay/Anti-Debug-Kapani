...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "5.0.3"
  WORKING_DIRECTORY "C:/Users/gizem/.gemini/antigravity/scratch/AntiDebugTrap/build/_deps/capstone-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 5.0.3")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/gizem/.gemini/antigravity/scratch/AntiDebugTrap/build/_deps/capstone-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/gizem/.gemini/antigravity/scratch/AntiDebugTrap/build/_deps/capstone-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
